...
@section('content')
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Manajemen Kategori Pengeluaran') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-2xl font-bold">Daftar Kategori Pengeluaran</h3>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            ...
                                            <form action="{{ route('admin.expense-categories.destroy', $category->id) }}"
                                                ...
                                                onsubmit="return confirm('Apakah Anda yakin ingin menghapus kategori ini? Semua pengeluaran yang terkait dengan kategori ini harus dipindahkan atau dihapus terlebih dahulu.');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4"
                                            ...
                                            Belum ada kategori pengeluaran yang terdaftar.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
