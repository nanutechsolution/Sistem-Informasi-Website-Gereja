                    ...
                    <form action="{{ route('admin.members.update', $member->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="gender" id="gender"
                                ...
                                <option value="Laki-laki"
                                    {{ old('gender', $member->gender) == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="Perempuan"
                                    {{ old('gender', $member->gender) == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                            @error('gender')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="blood_type" id="blood_type"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                value="{{ old('blood_type', $member->blood_type) }}">
                            @error('blood_type')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="address" id="address" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('address', $member->address) }}</textarea>
                            @error('address')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="date" name="baptism_date" id="baptism_date"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    value="{{ old('baptism_date', $member->baptism_date ? $member->baptism_date->format('Y-m-d') : '') }}">
                                @error('baptism_date')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="date" name="sidi_date" id="sidi_date"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                                    value="{{ old('sidi_date', $member->sidi_date ? $member->sidi_date->format('Y-m-d') : '') }}">
                                @error('sidi_date')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="marital_status" id="marital_status"
                                ...
                                <option value="Menikah"
                                    ...
                                    Menikah</option>
                                <option value="Duda"
                                    {{ old('marital_status', $member->marital_status) == 'Duda' ? 'selected' : '' }}>Duda
                                </option>
                                <option value="Janda"
                                    {{ old('marital_status', $member->marital_status) == 'Janda' ? 'selected' : '' }}>Janda
                                </option>
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">{{ old('notes', $member->notes) }}</textarea>
                            @error('notes')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="Non-aktif"
                                    {{ old('status', $member->status) == 'Non-aktif' ? 'selected' : '' }}>Non-aktif
                                </option>
                                <option value="Pindah" {{ old('status', $member->status) == 'Pindah' ? 'selected' : '' }}>
                                    Pindah</option>
                            </select>
                            @error('status')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
