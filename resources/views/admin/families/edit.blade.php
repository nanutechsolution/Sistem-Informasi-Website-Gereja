...
@section('title', '| Edit Keluarga: ' . ($family->family_name ?? $family->headMember->full_name . ' Family'))
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.families.update', $family->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="family_name" class="block text-sm font-medium text-gray-700">Nama Keluarga
                                (Opsional)</label>
