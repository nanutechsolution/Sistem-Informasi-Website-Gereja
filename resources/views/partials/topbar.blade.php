    ...
    <div class="flex justify-between items-center w-full">
        ...
        <div class="flex items-center gap-2 md:gap-4 flex-shrink-0">
            ...
            <a href="#" class="flex items-center flex-shrink">
                <span
                    class="self-center text-xl md:text-2xl font-semibold text-gray-900 dark:text-white max-w-[120px] md:max-w-full truncate">
                    {{ $churchName }}
                </span>
            </a>
        </div>
        ...
        <div class="flex items-center gap-2 md:gap-4">
            ...
            <button type="button" onclick="toggleDarkMode()"
                ...
                <svg id="icon-sun" class="w-6 h-6 hidden" fill="currentColor" viewBox="0 0 20 20"></svg>
                <svg id="icon-moon" class="w-6 h-6 hidden" fill="currentColor" viewBox="0 0 20 20"></svg>
            </button>
